...
export default function WardrobesPage() {
  ...
  const showNext = () => {
    ...
    setSelectedImage(
      selectedImage === wardrobeDesigns.length - 1
        ? 0
        : selectedImage + 1
    );
  };
