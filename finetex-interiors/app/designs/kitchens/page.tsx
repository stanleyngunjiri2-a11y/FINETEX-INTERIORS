...
const kitchenDesigns = [
  ...
  {
    image:
      "https://images.unsplash.com/photo-1556911220-e15b29be8c8f?auto=format&fit=crop&w=1800&q=90",
    alt: "Modern kitchen with island",
  },
  {
    image:
      "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=1800&q=90",
    alt: "Kitchen renovation inspiration",
  },
  {
    image:
...
export default function KitchensPage() {
  ...
  const showNext = () => {
    ...
    setSelectedImage(
      selectedImage === kitchenDesigns.length - 1
        ? 0
        : selectedImage + 1
    );
  };
    ...
    <>
          ...
          <div className="container py-20 sm:py-28">
            ...
            <div className="mt-12 max-w-3xl">
              ...
              <p className="mt-6 max-w-2xl text-base leading-8 text-white/65 sm:text-lg">
                Explore kitchen styles and ideas from FINETEX INTERIORS.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white">
          <div className="container py-20 text-center sm:py-28">
            ...
            <p className="mx-auto mt-5 max-w-2xl leading-8 text-[#6b6b6b]">
              ...
              kitchen designed around your space.
            </p>
      ...
      {selectedImage !== null && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Kitchen design preview"
        ...
        >
          ...
          <button
            ...
            aria-label="Previous kitchen design"
          >
            <ChevronLeft size={24} />
          </button>
          ...
          >
            <Image
              src={kitchenDesigns[selectedImage].image}
              alt={kitchenDesigns[selectedImage].alt}
              fill
              sizes="100vw"
          ...
          <button
            ...
            aria-label="Next kitchen design"
          >
          ...
          <div className="absolute bottom-5 left-1/2 -translate-x-1/2 rounded-full bg-white/10 px-4 py-2 text-xs font-medium text-white/70 backdrop-blur">
            {selectedImage + 1} / {kitchenDesigns.length}
          </div>
        </div>
      )}
